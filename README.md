...
- `workflow_dispatch` — manual with `chapkit_version` input (PyPI version, e.g. `2.0.0`; only affects `-cli` images)
...
make build-py-cli CHAPKIT_VERSION=2.0.0   # pin a specific PyPI version
