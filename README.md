...
- `workflow_dispatch` — manual with `chapkit_version` input (PyPI version, e.g. `2.1.2`; only affects `-cli` images)
...
make build-py-cli CHAPKIT_VERSION=2.1.2   # pin a specific PyPI version
